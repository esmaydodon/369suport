<template>
  <div class="app-container">
            ...
            >
              ...
              >
                <template slot-scope="scope">
                  <el-button v-if="scope.row.vinculolaboral == null" type="info" icon="el-icon-plus" plain @click="abriModalAgregarVinculoLaboral(scope.row)">CREAR</el-button>
                  <el-button v-else type="primary" icon="el-icon-view" plain @click="abrirModalDetalleVinculoLaboral(scope.row)">VER</el-button>
                </template>
              </el-table-column>
              <el-table-column
                header-align="center"
    ...
    >
      <agregar-editar-vinculo-laboral :vinculo-laboral-id="VinculoLaboralEditar_id" :vinculo-id="personaCrearVinculo_Id" @close="cerrarModalAgregarEditarVinculoLaboral" />
    </el-dialog>
    ...
    <el-dialog
      ...
      fullscreen
    >
      <detalle-vinculo-laboral :vinculo-laboral-id="vinculoLaboralVerDetalleId" @close="cerrarModalDetalleVinculoLaboral" />
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    listaVinculoLaboral() {
      this.loading = true
      vinculoLaboralResource.list(this.listQuery)
        .then(
          (response) => {
