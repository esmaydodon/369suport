...
export default {
  ...
  methods: {
    ...
    handleCambiarEstadoTipoCirugia(salaOperacionesId, activar) {
      if (activar) {
        this.loading = true
        tiposCirugiaResource.cambiarEstado(salaOperacionesId)
          .then(
            (response) => {
              this.$message({
                type: 'info',
    ...
    handleEliminarTipoCirugia(salaOperacionesId) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          this.loading = true
          tiposCirugiaResource.destroy(salaOperacionesId)
            .then(
              (response) => {
                this.$message({
                  type: 'info',
    ...
    abrirModalEditar(salaOperacionesId) {
      ...
      this.tipoCirugiaEditar_Id = salaOperacionesId
      this.$nextTick(() => {
        this.modalAgregarEditar = true
      })
    },
